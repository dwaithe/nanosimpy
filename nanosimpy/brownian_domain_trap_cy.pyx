...
def brownian_domain_trap(track_arr_py,num_of_steps_py, num_of_mol_py, id_list_py,width_py,map_img_py,phob_out_py,phob_in_py,R_py,R2_py,offset_py,scale_in_py,scale_out_py):
